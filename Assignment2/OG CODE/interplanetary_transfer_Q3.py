...
if __name__ == "__main__":
    ...
    for arc_index in range(number_of_arcs):
        ...
        current_arc_initial_time = departure_epoch + arc_length * arc_index
        current_arc_final_time = departure_epoch + arc_length * (arc_index + 1)
        ...
        if Q3a == True:
            ...
            time_days_3a = (times_3a - departure_epoch) / constants.JULIAN_DAY
        ...
        if Q3d == True:
            ...
            while True:
                ...
                final_state_deviation_3d = np.linalg.norm(r_3d - r_bar_3d)

                if final_state_deviation_3d < tolerance:
                    print('arc done')
                    break
    ...
    # 3c plot
    if Q3c == True:
        ax3c.set_xlabel('Time since departure (days)')
    ...
    if Q3d == True:
        ...
        ax3d.set_xlabel('Time since departure (days)')
