...
def get_perturbed_accelerations(central_body: str, bodies: environment.SystemOfBodies):
    ...
    if central_body == 'Callisto':
        ...
        raise ValueError('central_body must be either "Callisto" or "Ganymede"')
    ...
    acceleration_settings = {
        ...
        central_body:   [propagation_setup.acceleration.spherical_harmonic_gravity(2,2)],
        other_moon:     [propagation_setup.acceleration.point_mass_gravity()]
        }}

    if central_body == 'Ganymede':
        acceleration_settings['JUICE']['Ganymede'].append(propagation_setup.acceleration.aerodynamic())
